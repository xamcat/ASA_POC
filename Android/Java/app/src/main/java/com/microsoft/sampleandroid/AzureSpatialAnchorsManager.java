...
class AzureSpatialAnchorsManager {
    ...
    public static final String SpatialAnchorsAccountId = "badb57cb-9078-4878-93e2-726d0dc80459";

    // Set this string to the account key provided for the Azure Spatial Service resource.
    public static final String SpatialAnchorsAccountKey = " d4p3qmgg/mJooM6BWZMIbYT6VPaiTH593J6UwjEe8V4=";
